...
module.exports = {
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin({ //根据模板插入css/js等生成最终HTML
      favicon: './public/favicon.png', //favicon路径
  ...
  module: {
    loaders: [{
      ...
      {
        test: /\.(css|scss)$/,
        loader: ExtractTextPlugin.extract("style-loader", 'css-loader!postcss-loader!sass-loader') // 多进程打包
      },
      {
        test: /\.svg$/,
